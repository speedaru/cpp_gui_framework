...
public:
    ...
    void Render() override {  
        ...
        ImGui::Begin("Dashboard", m_pIsOpen, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize);  
          
        ImGui::TextColored(IMGUI_COLORS::skyBlue, "Framework Active");  
...
void Render() {
    ...
    // auto center it based on the window and button size
    g_guiGeom.CalculateAndSetCenterX(button.size.x);
    
    // update active state (clicked), use like normal imgui widget
